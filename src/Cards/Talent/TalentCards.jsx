...
const TalentCards = ({ userpic, name, text, connect, landingtalent }) => {
  return (
    <div className="overflow-hidden">
      <div className={`bg-[#ECF5FE] rounded-2xl p-5 w-[228px] ${landingtalent && '2xl:min-h-[433px] 2xl:min-w-[356px]'} ${connect && 'w-[222px] tracking-tighter'} min-h-min h-[250px]`}>
        <div className="flex flex-col gap-3 space-y-2 h-full">
          ...
          <div className="flex justify-between items-center mt-auto">
            <button className={`bg-black ${landingtalent ? '2xl:min-w-[248px] w-full 2xl:text-2xl 2xl:mt-5' : 'w-full'} rounded-3xl text-white py-2`}>
            ...
            {landingtalent ? (
              ...
              <IoMailOutline className="text-4xl ml-3" />
            )}
          </div>
        </div>
      </div>
