    ...
    <div className='land md:w-full  '>
      ...
      <div className="abe flex-col-reverse flex md:flex md:flex-row pt-10 pl-10 mt-5">
        <div className="left md:ml-8 md:w-1/2">
          ...
          <p className=' abe 2xl:mt-8 mt-5 md:text-xl text-center md:text-start text-[#252525]'>Empowering artists to forge meaningful connections and bring creative visions to life.Join the artistic revolution at YouTooArt.</p>
          ...
          <div className='flex gap-4 mt-44'>
            ...
            <img src={playstore} className='w-[25%] shadow-xl' alt="Play Store" />
          </div>
      ...
      <div className="land3">
        <div className='m-20 pb-10 md:w-[80%] md:mb-10 md:flex'>
          <div className="">
            <h1 className='segoe change text-4xl lg:text-6xl'>Find The Right Talent</h1>
      ...
      <div className="land4  flex flex-col justify-center bg-[#F4F4F4]">
        <div className='mx-20 my-10 pt-8 pb-8 md:pb-0 md:pt-20 lg:w-[80%]'>
          <div className=''>
            <h1 className='segoe text-4xl lg:text-6xl'>Find The Right Casting Call</h1>
        ...
        <button className='segoe p-3 mb-10 lg:mb-20 rounded-3xl mt-[-60px]  border w-36  border-black ml-20'>Discover More</button>
      ...
      <div className="land5">
        <div className='m-20'>
          <h1 className='segoe change  text-2xl lg:text-6xl text-center md:text-start md:text-4xl'>How it Works</h1>
        </div>
        <div className="data md:m-20 m-10 md:flex md:w-[80%]">
          ...
          <div className="right md:w-1/2 flex flex-col gap-5 lg:ml-10">
            <div className='border-b hidden md:block flex-col gap-2 border-gray-300'>
              <h1 className='segoe font-semibold change text-2xl'>Craft Your Identity,Share Your Passion</h1>
              <p className='segoe change text-[#7E8B9A]  mb-4'>Your artistic journey begins with YouTooArt's personalized profile</p>
            </div>
            <div className='border-b flex flex-col gap-2 border-gray-300'>
              <h1 className='segoe font-semibold change text-2xl'>Discover, Apply, Shine.</h1>
              <p className='segoe change text-[#7E8B9A] mb-4'>Unlock a world of opportunities through YouTooArt's diverse casting calls. From indie projects to collaborations with ren</p>
            </div>
            <div>
              <h1 className='segoe font-semibold change text-2xl flex flex-col gap-2'>Connect, Collaborate, Create.</h1>
              <p className='segoe change text-[#7E8B9A] mb-4'>YouTooArt revolutionizes artistic collaboration with powerful tools. Seamlessly connect with fellow artists, discuss projects</p>

              <button className='segoe change p-3 border rounded-3xl border-black mt-7'>Get Started</button>
      ...
      <div className="land6 bg-[#F4F4F4]">
        ...
        <div className="details border-t flex flex-col border-gray-300 m-20">
          <div onClick={() => handleVisible(0)} className="one mt-20 border-b border-gray-300 flex w-full">
          ...
          <div onClick={() => handleVisible(1)} className="cursor-pointer two mt-7 border-b border-gray-300 flex w-full">
            ...
            <div className="data w-[60%]">
              <h1 className='segoe text-xl font-semibold mb-4'>How does youtooart.com work?</h1>
              {visibleSections[1] && <p className='segoe 2xl:text-xl change text-sm mb-4 text-gray-500'>
                Youtooart.com is an online networking platform that allows people of various artistic interests to communicate, collaborate and come up with their own artworks.
              </p>}
            </div>
            <div className="w-[20%] flex justify-end items-start">
          ...
          <div onClick={() => handleVisible(2)} className="cursor-pointer three mt-7 border-b border-gray-300 flex w-full">
            ...
            <div className="data w-[60%]">
              <h1 className='segoe text-xl font-semibold mb-4'>How does youtooart.com help a certain user with a particular interest in some art category?</h1>
              {visibleSections[2] && <p className='segoe 2xl:text-xl change text-sm mb-4 text-gray-500'>
                Youtooart.com is an online networking platform that allows people of various artistic interests to communicate, collaborate and come up with their own artworks.
              </p>}
            </div>
            <div className="w-[20%] flex justify-end items-start">
          ...
          <div onClick={() => handleVisible(3)} className="cursor-pointer four mt-7 border-b border-gray-300 flex w-full">
            ...
            <div className="data w-[60%]">
              <h1 className='segoe text-xl font-semibold mb-4'>How does youtooart.com help people who are trying to perceive a full-time career in arts?</h1>
              {visibleSections[3] && <p className='segoe 2xl:text-xl change text-sm mb-4 text-gray-500'>
                Youtooart.com is an online networking platform that allows people of various artistic interests to communicate, collaborate and come up with their own artworks.
              </p>}
            </div>
            <div className="w-[20%] flex justify-end items-start">
          ...
          <div onClick={() => handleVisible(4)} className="cursor-pointer five mt-7 border-b border-gray-300 flex w-full">
            ...
            <div className="data w-[60%]">
              <h1 className='segoe text-xl font-semibold mb-4'>Anything else from Youtooart.com?</h1>
              {visibleSections[4] && <p className='segoe 2xl:text-xl change text-sm mb-4 text-gray-500'>
                Youtooart.com is an online networking platform that allows people of various artistic interests to communicate, collaborate and come up with their own artworks.
              </p>}
            </div>
      ...
      <div className="land8 bg-[#F4F4F4]">
        <div className='md:mx-20 flex justify-center items-center flex-col'>
          ...
          <div className='flex justify-center items-center flex-col mt-8'>
            <h1 className=' segoe md:text-4xl  2xl:text-5xl text-2xl w-[70%] text-center'>Connect with Us – Let's Shape Your YouTooArt Experience.</h1>
            <p className=' segoe lg:mt-8 mt-5 md:m-0 m-10 2xl:text-xl text-center md:text-start'>Have questions, suggestions, or need assistance? We're here for you!</p>
          </div>
          <div>
            <button className='segoe p-3 border 2xl:text-xl rounded-3xl border-gray-600 mt-7 mb-20'>Contact Us</button>
          </div>
