...
const NoDataFound = ({ data, description = "We couldn't find any data to display" }) => {
 const  message = "No data found"
  return (
    <div className="min-h-[400px]  flex flex-col items-center justify-center m-[2px] p-8 bg-white rounded">
      ...
      <h3 className="text-2xl font-semibold text-gray-800 mb-2">{data ? data : message}</h3>
